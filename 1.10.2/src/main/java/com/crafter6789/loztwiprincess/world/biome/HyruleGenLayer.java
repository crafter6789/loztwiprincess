...
public class HyruleGenLayer extends GenLayer
{
    ...
    public HyruleGenLayer(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        
        this.parent = p_i2122_3_;
        
        this.desertBiomes.addAll(desertBiomes);
        this.warmBiomes.addAll(warmBiomes);
        this.coolBiomes.addAll(coolBiomes);
        this.icyBiomes.addAll(icyBiomes);
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            //TODO this clear not there usually
            //desertBiomes.clear();
            
            desertBiomes.add(new BiomeEntry(BiomeRegistry.biomeHyruleField, 10));
            warmBiomes.add(new BiomeEntry(BiomeRegistry.biomeHyruleField, 10));
            coolBiomes.add(new BiomeEntry(BiomeRegistry.biomeHyruleField, 10));
            icyBiomes.add(new BiomeEntry(BiomeRegistry.biomeHyruleField, 10));
        }
        else
        {
