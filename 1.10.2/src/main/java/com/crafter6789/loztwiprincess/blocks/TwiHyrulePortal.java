...
public class TwiHyrulePortal extends BlockBreakable
{
    ...
    {
        TwiHyrulePortal.Size blockportal$size = new TwiHyrulePortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            TwiHyrulePortal.Size blockportal$size1 = new TwiHyrulePortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_)
    {
        ...
        TwiHyrulePortal.Size blockportal$size = new TwiHyrulePortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new TwiHyrulePortal.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size
        {
            ...
            public void placePortalBlocks()
            {
                for (int i = 0; i < this.width; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), Blocks.PORTAL.getDefaultState().withProperty(TwiHyrulePortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
