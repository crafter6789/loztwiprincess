...
public class MItems {
	...
	public static ArmorMaterial HyrlChanArmorMaterial = EnumHelper.addArmorMaterial("HyrlChanArmorMaterial", 19, new int[]{3, 5, 4, 3}, 12);
	...
	public static void initializeItem(){
		...
		HyrlChanHelm = new com.crafter6789.loztwiprincess.item.MArmor("HyrlChanHelm", HyrlChanArmorMaterial, "HyrlChanHelm", 0);
		HyrlChanChest = new com.crafter6789.loztwiprincess.item.MArmor("HyrlChanChest", HyrlChanArmorMaterial, "HyrlChanChest", 1);
		HyrlChanLegs = new com.crafter6789.loztwiprincess.item.MArmor("HyrlChanLegs", HyrlChanArmorMaterial, "HyrlChanLegs", 2);
		HyrlChanBoots = new com.crafter6789.loztwiprincess.item.MArmor("HyrlChanBoots", HyrlChanArmorMaterial, "HyrlChanBoots", 3);
