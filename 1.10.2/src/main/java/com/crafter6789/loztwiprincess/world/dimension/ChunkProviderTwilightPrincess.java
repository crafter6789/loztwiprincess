...
public class ChunkProviderTwilightPrincess implements IChunkGenerator
{
    ...
    public ChunkProviderTwilightPrincess(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_)
    {
        {
