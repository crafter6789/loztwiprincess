...
public class ChunkProviderTwilightPrincess implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderTwilightPrincess(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
