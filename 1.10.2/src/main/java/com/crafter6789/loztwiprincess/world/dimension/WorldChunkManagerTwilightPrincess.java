...
import com.crafter6789.loztwiprincess.world.biome.HyruleGenLayer;
...
public class WorldChunkManagerTwilightPrincess extends WorldChunkManager {
	...
	public WorldChunkManagerTwilightPrincess()
	{
	...
	{
		this();
		GenLayer[] agenlayer = HyruleGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerTwilightPrincess(World world)
	{
