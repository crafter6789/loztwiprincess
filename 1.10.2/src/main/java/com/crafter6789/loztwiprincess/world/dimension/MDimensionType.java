...
public enum MDimensionType {
	
	HYRULE(0, "Hyrule", "_hyrule", WorldProviderTwilightPrincess.class);
    ...
    private MDimensionType(int idIn, String nameIn, String suffixIn, Class <? extends WorldProvider > clazzIn)
    {
        this.id = idIn;
        this.name = nameIn;
    ...
    public static MDimensionType getById(int id)
    {
        for (MDimensionType dimensiontype : values())
        {
    ...
    public MDimensionType setLoadSpawn(boolean value) { this.shouldLoadSpawn = value; return this; }
