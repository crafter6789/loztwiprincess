...
//	public static final String REQFORGE = "required-after:Forge@[10.13.4.1558,)";
	public static final String REQMC = "[1.7.2,1.7.10]";
	
	public static final String DESC = "FORGE VERSION 10.13.4.1558 FOR MC VERSION 1.7.10 AND JAVA VERSION 1.8.0_92";
//	public static final String URL = "nonexistant";
//	public static final String UPDATEURL = "nonexistant";
