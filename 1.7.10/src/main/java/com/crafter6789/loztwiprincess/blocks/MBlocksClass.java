...
public class MBlocksClass {
	...
	public static void initializeBlock(){
		...
		RPGrassUsed = new RPGrassUsed("RPGrassUsed", Material.grass).setBlockName("RPGrassUsed").setCreativeTab(MCreativeTabs.tabUtil).setBlockTextureName(RefStrings.MODID + ":RPGrassUsed");
